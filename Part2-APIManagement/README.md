...
2.4 Outlook needs to know the sender beforehand in order to trust the incoming actionable message. Enter here the **Microsoft 365 Developer Account** or the mail address from your smtp provider.  
...
3.1. Go to the SAP Cloud Integration then click on **Artifacts** and open the "CAI Create Leave Request" iFlow
